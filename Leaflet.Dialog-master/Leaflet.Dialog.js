L.Control.Dialog = L.Control.extend({
  ...
  open: function() {
    ...
    this._mapa.fire("dialog:opened", this);
  ...
  close: function() {
    ...
    this._mapa.fire("dialog:closed", this);
    return this;
  },
  ...
  destroy: function() {
    ...
    this._mapa.fire("dialog:destroyed", this);
    this.remove();

    if (this.onRemove) {
      this.onRemove(this._mapa);
    }
  ...
  lock: function() {
    ...
    this._mapa.fire("dialog:locked", this);
    return this;
  },
  ...
  unlock: function() {
    ...
    this._mapa.fire("dialog:unlocked", this);
    return this;
  },
  ...
  freeze: function() {
    ...
    this._mapa.fire("dialog:frozen", this);
    return this;
  },
  ...
  unfreeze: function() {
    ...
    this._mapa.fire("dialog:unfrozen", this);
    return this;
  },
  ...
  hideClose: function() {
    ...
    this._mapa.fire("dialog:closehidden", this);
    return this;
  },
  ...
  showClose: function() {
    ...
    this._mapa.fire("dialog:closeshown", this);
    return this;
  },
  ...
  hideResize: function() {
    ...
    this._mapa.fire("dialog:resizehidden", this);
    return this;
  },
  ...
  showResize: function() {
    ...
    this._mapa.fire("dialog:resizeshown", this);
    return this;
  },
  ...
  update: function() {
    ...
    this._container.style.visibility = "";
    this._mapa.fire("dialog:updated", this);
  },
  ...
  _handleResizeStart: function(e) {
    ...
    L.DomEvent.on(this._mapa, "mousemove", this._handleMouseMove, this);
    L.DomEvent.on(this._mapa, "mouseup", this._handleMouseUp, this);

    this._mapa.fire("dialog:resizestart", this);
    this._resizing = true;
  },
  ...
  _handleMoveStart: function(e) {
    ...
    this._mapa.fire("dialog:movestart", this);
    this._moving = true;
  },
  ...
  _handleMouseUp: function() {
    L.DomEvent.off(this._mapa, "mousemove", this._handleMouseMove, this);
    L.DomEvent.off(this._mapa, "mouseup", this._handleMouseUp, this);

    if (this._resizing) {
      this._resizing = false;
      this._mapa.fire("dialog:resizeend", this);
    }

    if (this._moving) {
      this._moving = false;
      this._mapa.fire("dialog:moveend", this);
    }
  },
  ...
  _move: function(diffX, diffY) {
    ...
    this._mapa.fire("dialog:moving", this);
  ...
  _resize: function(diffX, diffY) {
    ...
    this._mapa.fire("dialog:resizing", this);
  },
